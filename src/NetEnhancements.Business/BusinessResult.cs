...
namespace NetEnhancements.Business
{
    ...
    public class BusinessResult
    {
        ...
        /// <summary>
        /// Initialize a successful or unsuccesful instance.
        /// </summary>
        public BusinessResult(bool notFound = false, bool otherError = false, string? statusMessage = null)
        {
            // This must be an non-short-circuiting OR (|) between all current and future error bools. Inline assignment ftw.
            Success = !(
                (NotFound = notFound) |
    ...
    public class BusinessResult<T> : BusinessResult
    {
        ...
        /// </summary>
        public BusinessResult(T data, string? statusMessage = null)
        {
            Data = data;
            Success = data != null;
            StatusMessage = statusMessage;
